#' Ler tabelas baixadas com tjam_baixar_tabela_docs
#'
...
#' @export
#'
tjam_ler_tabela_docs <- function(arquivos = NULL, diretorio = "."){
    ...
    suppressMessages({
      df <-   .x %>%
        ...
        dplyr::mutate(pagina_inicial = stringr::str_extract(paginas,"\\d+"),
                      ...
                      processo = processo,
                      url_doc = paste0("https://consultasaj.tjam.jus.br/pastadigital/getPDF.do?",url_doc)) %>%
